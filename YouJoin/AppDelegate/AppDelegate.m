...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    if ([kYJUserDefault valueForKey:@"hasLogged"]) {
        DYJTabbarController *mainPage = [[DYJTabbarController alloc]init];
        [self.window setRootViewController:mainPage];
    } else {
        WelcomePage *welcomePage = [WelcomePage new];
        UINavigationController *naviVc = [[UINavigationController alloc]initWithRootViewController:welcomePage];
